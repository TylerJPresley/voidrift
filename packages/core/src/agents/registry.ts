...
export const ALL_TOOLS = [
  "read_file", "glob_files", "write_file", "edit_file",
  "execute_command", "web_search", "web_fetch",
  "lsp_definition", "lsp_references", "lsp_hover",
  "spawn_subagent", "connect_mcp_server", "run_task_agent",
  "save_memory", "schedule",
];

export const READ_TOOLS = [
  "read_file", "glob_files", "web_search", "web_fetch",
  "lsp_definition", "lsp_references", "lsp_hover",
];
...
const CORE_AGENTS: AgentManifest[] = [
  ...
  },
  {
    ...
    modelTier: "auto",
    prompt: PROMPT_PLAN,
    tools: [...READ_TOOLS, "read_plan", "write_plan", "update_plan"],
    approvalMode: "deny",
    allowedTools: [...READ_TOOLS, "read_plan", "write_plan", "update_plan"],
