...
3. Write every file listed in the task using `write_source_file()` for new files or full rewrites, and `edit_source_file()` for targeted modifications to existing files.
