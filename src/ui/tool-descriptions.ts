...
export function describeToolCall(name: string, argsStr: string): ToolDescription {
  ...
  const friendly: Record<string, string> = {
    read_file: "Read", glob_files: "Glob", search_contents: "Search", write_file: "Write", edit_file: "Edit",
    execute_command: "Run", web_search: "Search", web_fetch: "Fetch",
    save_memory: "Remember", schedule: "Schedule",
    read_plan: "Plan", add_plan: "Plan", remove_plan: "Plan", prioritize_plan: "Plan", update_plan: "Plan",
