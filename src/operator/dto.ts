...
export interface StatsResult {
  ...
  turns: number;
  duration: string;
  tools: { total: number; success: number; failed: number };
  models: Array<{ name: string; turns: number; inputTokens: number; outputTokens: number }>;
}
...
export const CreateAgentInputSchema = z.object({
  ...
  modelTier: z.string().default("auto"),
  prompt: z.string(),
