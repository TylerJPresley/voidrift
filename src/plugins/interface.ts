...
export class CoreAPI {
  ...
  registerSkill(entry: { name: string; description: string; triggers: { extensions?: string[]; files?: string[]; keywords?: string[] }; agents: string[]; content: string; active?: boolean }): void {
