...
- **Remove stale `spec/` references:** Gather produces `analysis/<file>.md`, not `spec/<module>.md`. Removed all `spec/` references from REQUIREMENTS.md, README.md, system.md, verify.md, plan.md, and filesystem.py. Removed dead spec-reading code from plan.py.
